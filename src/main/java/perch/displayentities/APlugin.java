...
import perch.displayentities.compability.Metrics;
import perch.displayentities.compability.PlaceHolders;
...
public abstract class APlugin extends JavaPlugin {
    ...
    public void onEnable() {
        try {
            ...
            try {
                ...
                log(ChatColor.GOLD, "#", "Enabled (took &e" + (System.currentTimeMillis() - now) + "&f ms)");
                return;
            }
    ...
    public final void onReload() {
        ...
        reloadConfigs();
        reload();
        log(ChatColor.GOLD, "#", "Reloaded (took &e" + (System.currentTimeMillis() - now) + "&f ms)");
    }
